...
Python Native SAASS operates through two command-line scripts, saass_train.py which trains the regional and boundary models, and segment_image.py, which segments and image into foreground and background.


Requirements: numpy dicom scipy
...
`PGM Course Page <https://www.coursera.org/course/pgm>`_
...
`Heidelberg Lectures <http://www.youtube.com/watch?v=NOXTvnCGhRM>`_
...
`NonParametric Lecture <http://www.youtube.com/watch?v=30yDDzLGviM>`_
...
`Mathematical Monk <http://www.youtube.com/user/mathematicalmonk>`_
